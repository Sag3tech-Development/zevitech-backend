...
import { LtoAccountsInterface } from "interfaces/model-interfaces.js";

import { EmailValidator } from "utils/email-validator.js";
import { PhoneNumberValidator } from "utils/number-validator.js";

const LtoAccountsModel: Schema<LtoAccountsInterface> =
  new Schema<LtoAccountsInterface>(
    {
      formId: {
        type: String,
        required: true,
...
const LtoAccounts = model<LtoAccountsInterface>(
  "LtoAccounts",
  LtoAccountsModel
);
export default LtoAccounts;
